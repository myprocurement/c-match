...
import com.avricot.cboost.conf.metrics.DatabaseHealthCheck;
...
import static com.avricot.cboost.conf.WebConfigurer.HEALTH_CHECK_REGISTRY;
import static com.avricot.cboost.conf.WebConfigurer.METRIC_REGISTRY;
